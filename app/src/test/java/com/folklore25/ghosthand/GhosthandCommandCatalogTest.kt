...
class GhosthandCommandCatalogTest {
    ...
    fun paramsExposeMachineReadableLocationsAndCommandsExposeResponseFields() {
        ...
        assertTrue(screenRoute.params.any { it.name == "includePreview" })
        ...
        assertTrue(screenRoute.responseFields.contains("previewToken"))
        ...
        assertTrue(screenRoute.responseFields.contains("previewImage"))
        ...
        assertTrue(screenRoute.description.contains("includePreview=thumb"))
